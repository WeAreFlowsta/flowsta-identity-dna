...
# Build script for Flowsta Identity DNA v1.4

set -e

echo "Building Flowsta Identity DNA v1.4 (profile_picture removed from public DHT)"
...
echo ""
echo "Outputs:"
echo "  - DNA: workdir/flowsta_identity_v1_4.dna"
echo "  - hApp: workdir/flowsta_identity_v1_4_happ.happ"
